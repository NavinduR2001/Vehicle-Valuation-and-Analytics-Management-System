...
function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    adminService
      .getStats()
      .then((res) => {
        if (mounted && res.data && res.data.stats) setStats(res.data.stats);
      })
      .catch(() => {
        /* ignore for now */
      });
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        id="summary"
        sx={{
          display: activeButton === "Valuation Summary" ? "block" : "none",
          flexGrow: 1,
          p: 3,
          ml: "260px",
          bgcolor: "#ffff",
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              sx={{ color: "#990000", fontWeight: "bold" }}
            >
              {/* approved valuations */ stats.totalValuations ?? "-"}
            </Typography>
          </Box>
      ...
      <Box
        ...
        id="registered-users"
        sx={{
          display: activeButton === "Registered Users" ? "block" : "none",
          flexGrow: 1,
          p: 3,
          ml: "260px",
          bgcolor: "#f5f5f5",
      ...
      <Box
        ...
        id="valuation"
        sx={{
          display: activeButton === "Available Valuations" ? "block" : "none",
          flexGrow: 1,
          p: 3,
          ml: "260px",
          bgcolor: "#f5f5f5",
      ...
      <Box
        ...
        id="history"
        sx={{
          display: activeButton === "Valuation History" ? "block" : "none",
          flexGrow: 1,
          p: 3,
          ml: "260px",
          bgcolor: "#f5f5f5",
      ...
      <Box
        ...
        id="performance"
        sx={{
          display: activeButton === "Performance" ? "block" : "none",
          flexGrow: 1,
          p: 3,
          ml: "260px",
          bgcolor: "#f5f5f5",
